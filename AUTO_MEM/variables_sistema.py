...
#df_gen_real = objetoAPI.request_data("Gene","Sistema",dt.date(2024,1,1),dt.date(2024,1,28))
#df_aportes = objetoAPI.request_data("AporEner","Sistema",dt.date(2024,1,1),dt.date(2024,1,26))
#df_demanda = objetoAPI.request_data("DemaReal","Sistema",dt.date(2024,1,1),dt.date(2024,1,26))
#df_volutil = objetoAPI.request_data("PorcVoluUtilDiar","Sistema",dt.date(2024,1,1),dt.date(2024,1,26))
#df_poraportes = objetoAPI.request_data("PorcApor","Sistema",dt.date(2024,1,1),dt.date(2024,1,26))
...
df_gene_rec = objetoAPI.request_data("Gene","Recurso",dt.date(2024,5,15),dt.date(2024,6,15))
df_recurso = objetoAPI.request_data('ListadoRecursos','Sistema',dt.date(2024,5,15),dt.date(2024,6,15))
print(df_recurso)
...
df_agentes_compras = objetoAPI.request_data("CompContEner","Agente",dt.date(2024,3,15),dt.date(2024,4,15))
df_agentes_compras = df_agentes_compras.fillna(0)
df_agentes_compras = df_agentes_compras.drop('Id', axis=1)
df_agentes_ventas = objetoAPI.request_data("VentContEner","Agente",dt.date(2024,3,15),dt.date(2024,4,15))
df_agentes_ventas = df_agentes_ventas.fillna(0)
df_agentes_ventas = df_agentes_ventas.drop('Id', axis=1)
df_agentes_demanda = objetoAPI.request_data("DemaReal","Agente",dt.date(2024,3,15),dt.date(2024,4,15))
...
df_lista_rec_age = objetoAPI.request_data('ListadoRecursos','Agente',dt.date(2024,5,15),dt.date(2024,6,15))
